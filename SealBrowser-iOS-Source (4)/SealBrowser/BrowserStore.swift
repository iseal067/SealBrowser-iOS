...
final class BrowserTab: NSObject, ObservableObject, Identifiable, WKNavigationDelegate, WKUIDelegate {
    ...
    *{box-sizing:border-box;-webkit-tap-highlight-color:transparent}
    ...
    <body><div class="wrap"><div class="hero"><div class="logo">S</div><div class="brand">Seal Browser</div><div class="title">Browse in<br><span class="grad">electric blue.</span></div><div class="sub">Fast, clean and built for your phone. Your tabs will be waiting when you come back.</div></div><div class="searchhint"><b>Search from the bar below</b><br><span style="font-size:12px;color:#6f95ba">Enter a website, question or search.</span></div><div class="grid"><a class="tile" href="https://www.google.com/?hl=en&gl=gb"><div class="ico">G</div><b>Google</b><small>Search the web</small></a><a class="tile" href="https://www.youtube.com"><div class="ico">▶</div><b>YouTube</b><small>Watch videos</small></a><a class="tile" href="https://www.roblox.com"><div class="ico">R</div><b>Roblox</b><small>Jump into games</small></a><a class="tile" href="https://discord.com/app"><div class="ico">D</div><b>Discord</b><small>Open Discord</small></a></div><div class="foot">Fast • Clean • Yours</div></div></body></html>
    """#
}
